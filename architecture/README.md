...
For more information about what each of these are, or how to contribute, please visit [Blueprints and reference implementations](https://opentelemetry.io/docs/guidance/).
...
- Familiarity with the goals and scope of OpenTelemetry [Blueprints and reference implementations](https://opentelemetry.io/docs/guidance/) initiative
- A GitHub account and agreement to the [OpenTelemetry Contributor Guide](https://github.com/open-telemetry/community/blob/main/guides/contributor/README.md)
- Reviewed existing [blueprints](https://opentelemetry.io/docs/guidance/blueprints/) and [reference implementations](https://opentelemetry.io/docs/guidance/reference-implementations/) to avoid duplication

### Overview of the Workflow

1. Open a proposal issue in this ([`open-telemetry/sig-end-user`](https://github.com/open-telemetry/sig-end-user)) repository, and state whether you intend to author it (do not open a docs PR yet)
2. [Blueprints and Reference Implementation Team](https://github.com/orgs/open-telemetry/teams/sig-end-user-blueprints-approvers) reviews the proposal
3. Proposal is approved, needs changes, or declined
4. Once approved, open a documentation PR against [`open-telemetry/opentelemetry.io`](https://github.com/open-telemetry/opentelemetry.io)
...
this ([`open-telemetry/sig-end-user`](https://github.com/open-telemetry/sig-end-user)) repository using one of the
...
> **Important:** Do not open a PR against [`open-telemetry/opentelemetry.io`](https://github.com/open-telemetry/opentelemetry.io) at this stage.
...
The Blueprints and Reference Implementation Team reviews the proposal. Status is tracked via labels (see the
[Label Reference](#label-reference) table below). The team may request changes, approve, or
decline the proposal.

### Step 3 — Open the Documentation PR

Only after the proposal carries the `approved` status label.
Open the PR against the [`open-telemetry/opentelemetry.io`](https://github.com/open-telemetry/opentelemetry.io) repository (see the note under
